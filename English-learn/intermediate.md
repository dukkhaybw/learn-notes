英语句子有长有短，结构有简有繁。本质上来说，英语句子有其内在的结构规律， 这个基本的结构规律就是简单句的五种基本句型。
...
4. **近似于不及物动词的系动词**
   ...
   - Jane Austin died a spinster.   简·奥斯汀去世时，依然未嫁。
     ...
     a spinster作表语或者说是主语补足语，即补充说明主语Jane Austin的性质特征，所以可以将原句改写成Jane Austin was a spinster when she died.
...
重复指代先行词、起连接主句和从句的作用，**并且在定语从句中充当一定成分**的连接词称为关系词。
...
4. 先行词被any，only，all，every，no，some，much，few， little，序数词，形容词的最高级，the only，the one，the very，the right和the last等成分修饰时，用that
...
以上句子黑体部分的定语从句都是用来说明people的性质的，是必不可少的信息，因此不能加逗号将其变为非限制性定语从句。
...
例句1）的言外之意是“不知道的司机则没有换路线，只有部分司机换行驶路线了”。例句2）的言外之意 是“全部司机都知道，都换了行驶路线”。
...
**A. which**：**"which"** 是关系代词，用来引导定语从句，修饰前面的名词。但这里的 **"which"** 不能引导地点从句，它也没有与句子主干合理结合，因此不合适。
...
- The newly described languages were often **so strikingly** different from the well studied languages of Europe and Southeast Asia **that** some scholars even accused Boas and Sapir of fabricating their data.
  ...
  这些新近被描述的语言与已经得到充分研究的欧洲和东南亚地区的语言往往差别显著，以至于有些学 者甚至指责博阿斯和萨皮尔编造了材料。



用such...that来引导结果状语从句，**such的后面要接名词**。
...
- He is so good a teacher that everyone likes him.
  ...
  - **主语（Subject）**：He
  - **系动词（Linking verb）**：is
  - 表语（Predicate adjective）：so good a teacher
    - **so good a teacher** 是一个倒装结构，正常语序是 **a teacher so good**。这里 **"so good"** 是形容词，修饰名词 **"teacher"**，表示“如此优秀的老师”。
...
___that the pilot couldn't fly through it. 
...
正常语序：The storm was so severe that the pilot couldn't fly through it.
...
句子 **"It was so expensive a car that we couldn't afford to buy it."** 是一个包含 **“so...that”** 结构的句子，其中 **“so...that”** 引导 **结果状语从句**。此外，它还包含了一个 **倒装结构**，**“so + 形容词 + a + 名词”**。
...
1. 主句部分：
   ...
   - **系动词（Linking verb）**：was

   - 表语（Predicate adjective）

     ：so expensive a car

     - **so expensive a car** 是一个倒装结构，表示“如此昂贵的一辆车”。正常语序是 **a car so expensive**，但为了强调“昂贵”，使用了倒装。

2. 结果状语从句（Result clause）：

   - **that we couldn't afford to buy it**：**that** 引导的从句作为结果状语从句，表示前半句的结果，意思是“我们买不起”。

详细解析：

- **so...that**：这是一个常见的结果状语从句结构，表示由于某个条件（这里是“车太贵了”）导致的结果（我们买不起）。
- **so expensive a car**：这是一个倒装结构，用来强调形容词 **expensive**，形容词和名词 **a car** 的顺序进行了倒置，以强调“昂贵”。
- **that we couldn't afford to buy it**：结果状语从句，表示结果“我们买不起”。

句子结构图：

- **主语**：It
- **系动词**：was
- **表语**：so expensive a car
- **结果状语从句**：that we couldn't afford to buy it

对比非倒装结构：

- 非倒装形式可以是：**"The car was so expensive that we couldn't afford to buy it."**

总结：这个句子的结构是 **主语 + 系动词 + 表语 + 结果状语从句**，其中的 **“so + 形容词 + a + 名词”** 是为了强调程度而使用的倒装结构。
...
So involved with their computers___that leaders at summer computer camps often have to force them to break for sports and games. 
...
- 题目中的句子是一个倒装句，表示强调句型。**倒装句** 的结构是为了强调某个部分，将助动词提前，类似于 **So + 形容词/副词 + 助动词 + 主语 + 谓语** 的结构。
- **So involved with their computers** 是强调的形容词短语，表示孩子们被电脑所吸引到某种程度。
- 正常语序应该是：**The children become so involved with their computers that leaders at summer computer camps often have to force them to break for sports and games.**
- 但是为了强调 **so involved**，使用了倒装结构，因此正确选项应该是：
  - **So involved with their computers do the children become**，表示孩子们被电脑吸引得如此之深，以至于领导们不得不强迫他们休息进行体育活动。

错误选项解释：

- **A. became the children**：时态错误，became 是过去式，而句子主句使用的是一般现在时。
- **B. become the children**：缺少助动词，无法形成倒装句。
- **C. had the children become**：时态和结构错误，**had** 是过去完成时，与句子的语境不符。





It is________weather that I would like to go to the beach.  
...
在这句话中，**"It is ________ weather that I would like to go to the beach."** 是一个强调句型，使用了 **so...that** 或 **such...that** 结构来表示程度，意思是“天气如此好，以至于我想去海滩”。

- **so + 形容词 + a + 名词 + that** 是一个常见的倒装结构，用来强调形容词。正确的形式应该是 **"so nice a weather"**，表示“如此好的天气”。

选项分析：

- **A. so nice**：缺少冠词 **a**，因为 **weather** 是可数名词，需要冠词来限定。
- **B. such nice**：虽然 **such...that** 也可以用来表示程度，但 **such + nice weather** 少了冠词 **a**，不符合语法规则。
- **C. such a nice**：虽然是正确的结构，但通常用来表示“如此好的一种天气”，但这种表达更常用于 **“a type of”** 语境，而不适合强调单个名词的程度。
- **D. so nice a**：正确的倒装结构，符合语法规则，表达的是“如此好的天气”。
...
- The opinions expressed here are not necessarily the opinions of Yahoo! and we assume no responsibility for such content....Please do not post any private information unless you want it to be available publicly and never assume that you are completely anonymous and cannot be identified by your comments.（雅虎发表的免责申明）
...
- **意义**：假设、如果
- **语气**：假设性，通常用于提出一个假想的情景。
- **用法**：用来提出假设问题或情景，**suppose** 和 **supposing** 都可以互换使用，区别不大。可以省略 **that**。
- 例句：
  - *Suppose (that) you won the lottery, what would you do?* （假设你中了彩票，你会做什么？）
  - *Supposing (that) it rains tomorrow, what will we do?* （假设明天下雨，我们怎么办？）
- 区别：
  - **Suppose** 和 **supposing** 比较通用，常用于假设的情景提问。**Supposing** 稍显口语化。
  - 语法上属于假设，而非必然发生的条件。
...
- **语气**：强调条件，表示“如果…的条件满足”，语气较正式。

- **用法**：**Providing** 和 **provided** 通常可以互换使用。强调在某个特定条件下某事会发生，**that** 可以省略。

- **例句**：

  - *You can go to the party provided (that) you finish your homework.* （只要你完成作业，你就可以去参加聚会。）
  - *Providing (that) it doesn’t rain, we’ll have a picnic tomorrow.* （只要不下雨，我们明天会去野餐。）

- **区别**：

  - 强调条件较强，指**实际可以满足的前提条件**。
...
- **语气**：条件宽松或普通的条件。**So long as** 和 **as long as** 用法上差异很小，表示在某种情况下某事会发生。

- **用法**：两者基本上可以互换，表示条件或期限，侧重条件持续一段时间。

- **例句**：

  - *You can stay here as long as you like.* （只要你愿意，你可以待在这里。）
  - *So long as you are careful, you won’t have any problems.* （只要你小心，你不会有任何问题。）
...
- **意义**：条件是…
- **语气**：非常正式，强调在某种条件下才会发生。
- **用法**：常用于正式的书面语，强调在非常具体、严格的条件下某事会发生。
- **例句**：
  - *I will lend you the car on condition that you return it by 6 p.m.* （我可以把车借给你，条件是你必须在晚上6点前归还。）
- **区别**：
  - **On condition that** 语气最正式，通常用于严肃或法律类的场合，表示一个明确的条件。
...
子 **"Knowledge helps you to reach the destination."** 的结构是：

1. **主语**（Subject）：**Knowledge**
   - 由名词 **"Knowledge"** 充当，表示谁或什么做这个动作。
2. **谓语**（Verb）：**helps**
   - 动词 **"helps"** 充当，表示句子的主要动作。
3. **宾语**（Object）：**you**
   - 代词 **"you"** 充当，表示动作的承受者，也就是“帮助”的对象。
4. **宾补**（Object Complement）：**to reach the destination**
   - 动词不定式  "to reach the destination" 充当，表示宾语（"you"）的进一步状态或动作，解释你被帮助去做什么。这是个 动词不定式短语，其中：
     - **to reach** 是不定式动词，表示到达。
     - **the destination** 是不定式的宾语，表示目的地。



You can arrive in Beijing earlier for the meeting________you don't mind taking the night train. 
...
- **Provided** 表示“只要…的情况下”或“如果…的话”，引导一个条件从句，表示如果某个条件成立的话，那么主句中的事情就会发生。因此，“You can arrive in Beijing earlier for the meeting provided you don't mind taking the night train.” 意思是说“如果你不介意坐夜间火车的话，你可以提前到达北京参加会议。” 这是一个合理的逻辑关系。

其他选项不合适的原因如下：

- **Unless** 表示“除非…否则…”，通常用于表示一种否定的条件。如果使用 “unless”，句子会变成 “除非你不介意坐夜班火车，否则你不能早点到北京”，这里的逻辑关系是错误的，因为“不介意坐夜间火车”实际上是一个肯定的态度，不应该用“除非”来表达。
- **Though** 意为“虽然”，用来引出对比或转折的情况。如果使用 “though”，句子会变成 “You can arrive in Beijing earlier for the meeting though you don't mind taking the night train.” 这里没有明显的对比或转折关系，所以不适合使用 “though”。
- **Until** 意为“直到...为止”，用来表示动作持续到某个时间点。如果使用 “until”，句子会变成 “You can arrive in Beijing earlier for the meeting until you don't mind taking the night train.” 这句话在逻辑上讲不通，因为“不介意坐夜间火车”并不是一个时间点，而是一个态度或意愿。

综上所述，**provided** 是最合适的选项，因为它准确地表达了前提条件与结果之间的逻辑关系。



**Unless** 通常用来表示一个否定的条件，意思是“如果不……”或者“除非……”。在使用 **unless** 时，**它后面的从句应该表示一个阻止主句发生的情况**。例如：

- "I won't go to the party unless I finish my homework."（我不会去参加聚会，除非我完成了作业。）

在这个例子中，"I finish my homework" 是一个积极的行动，但是由于 **unless** 的使用，它变成了一个阻止我去聚会的条件，即如果我不完成作业，我就不会去聚会。

回到你的句子：

- "You can arrive in Beijing earlier for the meeting unless you don't mind taking the night train."

这里的逻辑是混乱的，因为：

- **You don't mind taking the night train** 是一个积极的态度，意味着你不介意坐夜车。
- 使用 **unless** 会把这句话解读为：“如果你介意坐夜车，你就不能提前到达北京参加会议。”

这显然不符合原句的意思。原句的意思应该是：“如果你不介意坐夜车，你就可以提前到达北京参加会议。” 因此，正确的逻辑关系应该用 **provided** 来表示，而不是 **unless**。





________you fell in love with your boss, what would you do? 

A．Provide B．Supposing C．Unless D．Except

选项分析：

1. **B. Supposing**（假设，假如）
   - **正确选项**。
     **Supposing** 用于引导假设性问题，表示“假如…会怎样”。题目中的句子是假设某种情况（你爱上了你的老板），询问在这种假设情况下你会做什么，符合句子的语境和逻辑。
     意思是：“假如你爱上了你的老板，你会怎么做？” 这是典型的假设性提问。
2. **A. Provide**（提供）
   - 不合适。
     **Provide** 是动词，表示“提供”，在这种假设性句子中并不适合。这里需要的是一个引导假设从句的词，而 **provide** 不能用于此。
3. **C. Unless**（除非）
   - 不合适。
     **Unless** 表示“除非…否则…”，用于引导否定条件句。如果用 **unless**，句子意思会变成“除非你爱上了你的老板，否则…”，这与题目中的假设逻辑不符。
4. **D. Except**（除了）
   - 不合适。
     **Except** 表示“除了…之外”，用于排除某个情况。用在这里不符合语境，因为题目是在进行假设，而不是排除某种情况。





Government cannot operate effectively________it is free from such interference. A．so long as B．if only C．unless D．lest

选项分析

1. **A. so long as**:
   - **意思**: 只要
   - **用法**: 表示一个持续的条件，**通常用于正面的条件**。
   - **例句**: 
     - You can stay out late so long as you promise to be back by midnight.
     - You can stay here so long as you behave well.
   - **问题**: 在这个句子中，"so long as" 表示的是一个正面的条件，但句子本身是在描述一个负面的情况（政府无法有效运作），所以不适合。
2. **B. if only**:
   - **意思**: 要是……就好了
   - **用法**: 用**于表示愿望或遗憾，通常带有强烈的感情色彩**。
   - **例句**: If only I had studied harder, I would have passed the exam.
   - **问题**: 这个句子需要一个表示条件的连词，而不是表达愿望或遗憾的短语，所以不适合。
3. **C. unless**:
   - **意思**: 除非
   - **用法**: 用于表示一个否定的条件，即如果某个条件不成立，则主句中的情况就不会发生。
   - **例句**: You cannot enter the building unless you have a valid ID.
   - **适用**: 在这个句子中，"unless" 完美地表达了“政府无法有效运作，除非它不受这种干预的影响”这一逻辑关系。
4. **D. lest**:
   - **意思**: 以免
   - **用法**: **用于表示为了避免某种不希望发生的情况**。
   - **例句**: She took an umbrella lest it should rain.
   - **问题**: 这个句子需要的是一个表示条件的连词，而不是表示避免某种情况的短语，所以不适合。
...
- **用法**：用于引导让步状语从句，语气较为随意，常用于口语和非正式写作。

- **例句**：Though it was raining, we decided to go for a walk.

- **特点**：可以放在句首或句中，也可以放在句末（但较少见）。
...
- **意思**：虽然，尽管
- **用法**：用于引导让步状语从句，语气比 **though** 更正式，常用于书面语。
- **例句**：Although it was raining, we decided to go for a walk.
- **特点**：通常放在句首或句中，不常用在句末。

用于表达与主句意思相反的事实。

**Though** 可以用在句末，**although** 不行。

- 正确：We went out for a walk, **though** it was raining.
- 错误：We went out for a walk, **although** it was raining.
...
- **意思**：即使，尽管
- **用法**：用于引导让步状语从句，语气比 **though** 和 **although** 更强烈，强调让步的程度，常用于表示与事实明显相反的情况。
- **例句**：Even though it was raining heavily, we decided to go for a walk.
- **特点**：**Even though** 不能放在句末。
...
在这两句中，**even though** 比 **though** 的语气更强烈，表达的是更出乎意料的情况。
...
- **意思**：即使，纵然
- **用法**：用于引导让步状语从句，语气比 **even though** 更强烈，常用于表示假设性的让步。
- **例句**：Even if it rains, we will still go to the park.
- **特点**：通常放在句首或句中，强调即使在假设的情况下也依然如此。

**细微差别总结**

1. **though** 和 **although**：
   - **though** 更口语化，常用于非正式场合。
   - **although** 更正式，常用于书面语。
   - 例句对比：
     - Though it was raining, we decided to go for a walk.（口语化）
     - Although it was raining, we decided to go for a walk.（书面语）
2. **even though** 和 **even if**：
   - **even though** 强调实际存在的让步，语气更强烈。
   - **even if** 强调假设性的让步，语气更强烈。
   - 例句对比：
     - Even though it was raining heavily, we decided to go for a walk.（实际存在的让步）
     - Even if it rains, we will still go to the park.（假设性的让步）



这些引导词主句前不可用but，但可用yet或still。
...
Although Professor Green's lectures usually ran (A) over the fifty-minute period, (B) but (C) none of his students (D) even objected as they found his lectures both informative and interesting.

尽管格林教授上课时间常超过50分钟，但是他的学生中没有一个人反对，因为他们觉得他的课既有趣 又有收获。
...
主要有despite, in spite of和for all。

although和though是连词，因 此后面只接从句（有时是省略形式的从句），而这里的介词只接名词 （短语），不能接从句。
...
**介词后面除了接名词短语外，还可以接 what引导的名词从句。**



________what he achieved in medicine, he remained modest. 

A．Despite B．Although C．If D．Whereas

因为这里what＝things that，引导的是一个名词性从句，其本质上相当于一个名词短语，故此处仍需用介词。若用连词though，则只能说成：Though he achieved a lot in medicine, he remained modest.



________tired, he wouldn't stop working. 

A．Despite B．For all C．Though D．Whereas

因为这是一个省略的状语从句，原句相当于Though he was tired, he wouldn't stop working. 所以要用连词，而不是介词，故C正确。

**选项分析**

1. **A. Despite**:
   - **意思**: 尽管
   - **用法**: **通常后面跟名词或动名词**，不能直接跟形容词或副词。
   - **例句**: Despite the rain, we decided to go for a walk.
   - **问题**: 在这个句子中，"Despite" 后面需要跟一个名词或动名词，而不能直接跟形容词 "tired"，所以不合适。
2. **B. For all**:
   - **意思**: 尽管
   - **用法**: **通常后面跟名词**，表示“尽管有……”。
   - **例句**: For all his wealth, he was not happy.
   - **问题**: 在这个句子中，"For all" 后面需要跟一个名词，而不能直接跟形容词 "tired"，所以不合适。
3. **C. Though**:
   - **意思**: 虽然，尽管
   - **用法**: 用于引导让步状语从句，可以直接跟形容词或副词。
   - **例句**: Though it was raining, we decided to go for a walk.
   - **适用**: 在这个句子中，"Though" 直接跟形容词 "tired"，完美地表达了“尽管很累，他还是不停止工作”这一逻辑关系。
4. **D. Whereas**:
   - **意思**: 而，然而
   - **用法**: 用于表示对比或对立的关系，通常连接两个并列的句子。
   - **例句**: He is very rich, whereas his brother is quite poor.
   - **问题**: 在这个句子中，"Whereas" 不适用于引导让步状语从句，而是用于表示对比，所以不合适。
...
在这个句子中，"tired" 实际上是省略了一个完整的状语从句的一部分。完整的状语从句可能是：

- **Though he was tired, he wouldn't stop working.**

省略规则

在英语中，**当从句的主语与主句的主语一致时，可以省略从句中的主语和系动词（be 动词）**。这样可以使句子更加简洁。具体来说：

- **完整形式**: Though he was tired, he wouldn't stop working.
- **省略形式**: Though tired, he wouldn't stop working.

其他例子

1. **完整形式**: Although she is happy, she still feels lonely sometimes.
   - **省略形式**: Although happy, she still feels lonely sometimes.
2. **完整形式**: Even though they were exhausted, they continued their journey.
   - **省略形式**: Even though exhausted, they continued their journey.
3. **完整形式**: Despite being busy, she managed to finish the project on time.
   - **省略形式**: Despite being busy, she managed to finish the project on time.

解释

- **Though + 形容词**：在这种情况下，"Though" 后面直接跟形容词，实际上是省略了主语和系动词。这种省略在口语和书面语中都很常见，特别是在让步状语从句中。



可以总结出这样的规律：介词后面可以接名词、名词短语、动名词或what引导的从句；连词后面可以接完整的陈述句、形容词（相当于省略句）、分词（相当于省略句）等。



#### while表示让步状语从句

while位于句首，一般意为“尽管”，引导让步状语从句。各种杂志和周刊文章中经常能够看到。
