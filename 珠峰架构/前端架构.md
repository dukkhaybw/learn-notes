...
npm最重要一环是：安装和维护项目依赖。在平时开发中删除node_modules后重新npm install是解决npm安装类问题的方法。但是其中的作用原理是？这样的操作是否符合规范？
...
![image-20220603225256263](C:\Users\dukkha\AppData\Roaming\Typora\typora-user-images\image-20220603225256263.png)
