...
一定要注意对于**函数组件**的jsx，生成的函数React.createElement调用中第一个参数就是函数本身，也就是说它是可以直接被执行的。
...
3. 事件触发阶段
   ...
   1. 事件提取阶段
      ...
      ![image-20240126131406962](images\image-20240126131406962.png)
...
![image-20240122092717999](images\image-20240122092717999.png)
...
![image-20240121211611546](images\image-20240121211611546.png)
...
![image-20240203092612693](images\image-20240203092612693.png)
