...
函数式编程是一种编程范式，这就意味着它有一些**特定的原则**来考虑软件架构。相比于命令式或面向对象的代码，函数式代码**更加简洁、可预测和易测试**，但如果不熟悉函数式编程以及与之相关的常见模式，那么函数式代码看起来会更加密集，并且与之相关的文章对于新手来说也很难理解。
